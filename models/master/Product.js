  ...
  static async create(product) {
    try {
      ...
      await pool.request()
        ...
        .query('INSERT INTO SanPham (MaSP, TenSP, MaNCC, MaLoaiSP, ThanhTien, SoLuongTonKho, SoLuongDatMua, MucDatHangLai, TrangThaiNgungBan) VALUES (@MaSP, @TenSP, @MaNCC, @MaLoaiSP, @ThanhTien, @SoLuongTonKho, @SoLuongDatMua, @MucDatHangLai, @TrangThaiNgungBan)');
    } catch (err) {
      throw err;
    }
  }
  ...
  static async update(id, product) {
    try {
      ...
      await pool.request()
        ...
        .input('MucDatHangLai', sql.SmallInt, MucDatHangLai)
        .input('TrangThaiNgungBan', sql.Bit, TrangThaiNgungBan)
        .query('UPDATE SanPham SET TenSP = @TenSP, MaNCC = @MaNCC, MaLoaiSP = @MaLoaiSP, ThanhTien = @ThanhTien, SoLuongTonKho = @SoLuongTonKho, SoLuongDatMua = @SoLuongDatMua, MucDatHangLai = @MucDatHangLai, TrangThaiNgungBan = @TrangThaiNgungBan WHERE MaSP = @MaSP');
    } catch (err) {
      throw err;
    }
  }
